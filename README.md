...
同一张照片，可以画成整幅水墨，也可以和水墨长在一起。本仓库收录两个互补的文生图 Skill，共享同一套笔墨与金墨标准。
...
1. **决策先行**：成画走"定锚点 → 定核心命题 → 选一个作者性决定 → 写意延伸"；嫁接走"执行卡"——锁定主主体、摄影区 P / 交接区 T / 水墨区 I、主出口和材料落点。缺失的事实标"未知"，不补成景物。
...
4. **单变量纠偏**：失败时定位首要失败项，只替换对应段落，永不向提示词尾部追加补丁——堆字就是失控的开始。
